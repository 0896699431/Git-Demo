...
import { Header, AdvancedSearchBox, PageLoading } from 'components'
...
function BookingList(props) {
  ...
  return (
    <Wrapper>
      <Header back title={featureName} icon={renderGetLocationButton()}>
        {/* {renderAdvancedSearchBox()} //hien thi o input de bam vao */}
      </Header>
      {renderBody()}
    </Wrapper>
  )
